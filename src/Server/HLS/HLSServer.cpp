...
HLSServer::HLSServer(ProgramConfig config, std::shared_ptr<DataChunk> dataChunk,std::shared_ptr<PipelineManager> pipManager): StreamingServer(config,dataChunk,pipManager)
{
    gst_init(NULL,NULL);
